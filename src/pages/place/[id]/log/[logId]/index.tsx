  ...
  return (
    <div className='bg-gray-100 min-h-screen'>
      ...
      <div className='flex items-center justify-center'>
        ...
        <GiLuckyFisherman className='ml-2 mb-3' size={32} />
      </div>
      <h2 className='text-center text-xl mb-10'>{fishLog.placeName} 釣行詳細記録</h2>
      <div className='max-w-lg mx-auto shadow-lg p-6 mb-10 bg-white'>
        <h2 className='text-center text-3xl font-semibold mb-8'>{fishLog.fishName}</h2>
        <div className='container'>
          <Table
            className='mb-10'
            hideHeader
          ...
          >
            ...
            <TableBody className='bg-gray-100'>
              ...
              <TableRow key={`weather-${fishLog.id}`}>
                ...
                <TableCell className='text-lg border border-t border-b border-gray-300 w-3/4'>
                  {((fishLog.isSunny && '晴れ') || '') +
                    ...
                    ((fishLog.isCloudy &&
                      (fishLog.isSunny || fishLog.isRainy ? '・' : '') + '曇り') ||
                      '')}
                </TableCell>
              </TableRow>
              ...
              <TableRow key={`tide-${fishLog.id}`}>
                ...
                <TableCell className='text-lg border border-gray-300 w-3/5'>
                  {fishLog.tide}
                </TableCell>
              </TableRow>
            </TableBody>
