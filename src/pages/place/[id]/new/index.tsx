          ...
          <TableBody>
            ...
            <TableRow>
              <TableCell className='border-t border-gray-300 border-b bg-gray-100 font-semibold w-1/4'>
                <label className='text-lg w-28'>
                  天気 <span className='text-red-500 text-sm'>(複数選択可)</span>
                </label>
              ...
              <TableCell className='border-t border-b border-gray-300 w-3/4'>
                <Controller
                  ...
                  render={({ field }) => (
                    <CheckboxGroup {...field}>
                      <Checkbox value='sunny' className='mb-2 ml-1'>
                        晴れ
                      </Checkbox>
                      <Checkbox value='rainy' className='mb-2 ml-1'>
                        雨
                      </Checkbox>
                      <Checkbox value='cloudy' className='mb-2 ml-1'>
                        曇り
                      </Checkbox>
                    </CheckboxGroup>
                  )}
            ...
            <TableRow>
              <TableCell className='border-t border-gray-300 border-b bg-gray-100 font-semibold w-1/4'>
                ...
                {errors.fishName && (
                  <span className='text-red-500 ml-2'>{errors.fishName.message}</span>
                )}
              </TableCell>
              <TableCell className='border-t border-b border-gray-300 w-3/4'>
                <Input
            ...
            <TableRow>
              <TableCell className='border-t border-gray-300 border-b bg-gray-100 font-semibold w-1/4'>
                <label className='text-lg w-28'>
                  大きさ<span className='text-red-500 text-sm'>(cm)</span>
                </label>
            ...
            <TableRow>
              ...
              <TableCell className='border-t border-b border-gray-300 w-3/4'>
                ...
                >
                  <Radio
                    value='大潮'
                    {...register('tide', { required: '潮汐情報は必須です' })}
                    className='mb-2 ml-1'
                  >
                    大潮
                  </Radio>
